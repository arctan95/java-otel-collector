...
public class OTLPGrpcServerBuilder {
    ...
    private OTLPGrpcServerBuilder(Builder builder) {
    ...
    public static class Builder {
        ...
        public OTLPGrpcServerBuilder build() {
            return new OTLPGrpcServerBuilder(this);
        }
    }
}
